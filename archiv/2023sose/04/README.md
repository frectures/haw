...
Als Platzhalter für `printf` bieten sich zu diesem Zweck `%2d` (zwei Ziffern) für die Faktoren
sowie `%4d` (vier Ziffern) für das Produkt an, dann sind die Zahlen schön rechtsbündig ausgerichtet.
